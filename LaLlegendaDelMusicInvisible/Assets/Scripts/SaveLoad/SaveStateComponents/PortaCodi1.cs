...
public class PortaCodi1 : MonoBehaviour
{
    public PlayableDirector playableDirector;
    public StateComponentsScriptable stateComponents;
    public PlayerPrefsMobleCodiPorta1 prefsData { get; private set; }
    ...
    {
        prefsData = PlayerPrefsPersistentData.LoadPortaCodi1();
    ...
    {
        PlayerPrefsPersistentData.SavePortaCodi1(this);
    }
}
