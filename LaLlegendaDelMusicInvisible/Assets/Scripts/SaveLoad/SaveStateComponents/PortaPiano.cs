...
public class PortaPiano : MonoBehaviour
{
    public PlayableDirector playableDirector;
    public StateComponentsScriptable stateComponents;
    public PlayerPrefsPortaSalaPiano prefsData { get; private set; }
    ...
    {
        prefsData = PlayerPrefsPersistentData.LoadPortaPiano();
    ...
    {
        PlayerPrefsPersistentData.SavePortaPiano(this);
    }
}
